...
{
    /// <inheritdoc />
    public partial class testresultstored : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CalendarGroupItems",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                    CalendarId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                    CalendarGroupId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CalendarGroupItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeZone = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                    ...
                    TimeScale = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
